  ...
  return (
    <div>
      <form onSubmit={handleSubmit} className="form-component max-w-sm mx-auto mb-5">
        ...
        <div className="mb-5">
          <label htmlFor="latitude_rs" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
            Latitude:
          </label>
          <input
            type="text"
        ...
        <div className="mb-5">
          <label htmlFor="longitude_rs" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
            Longitude:
          </label>
          <input
            type="text"
